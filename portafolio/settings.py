...
REST_FRAMEWORK ={
    ...
    'PAGE_SIZE': 3,
    # ESTO ES PARA PODER USAR EL INTERFAZ DE DRF
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',
        'rest_framework.renderers.BrowsableAPIRenderer',  # Asegúrate de tener esto
    ],
    # ACCEDE AL GET UNICAMENTE SI ESTOY AUTENCIADO
...
logger.info(f"AWS_ACCESS_KEY_ID: {config('AWS_ACCESS_KEY_ID')}")
logger.info(f"AWS_STORAGE_BUCKET_NAME: {config('AWS_STORAGE_BUCKET_NAME')}")
